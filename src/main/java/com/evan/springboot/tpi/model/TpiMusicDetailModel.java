...
@TableName("tpi_music_detail")
@ApiModel(value="TpiMusicDetailModel对象", description="")
public class TpiMusicDetailModel extends Model<TpiMusicDetailModel> {
